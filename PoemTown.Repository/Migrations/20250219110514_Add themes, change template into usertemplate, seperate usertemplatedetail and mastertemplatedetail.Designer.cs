...
namespace PoemTown.Repository.Migrations
{
    ...
    [Migration("20250219110514_Add themes, change template into usertemplate, seperate usertemplatedetail and mastertemplatedetail")]
    partial class Addthemeschangetemplateintousertemplateseperateusertemplatedetailandmastertemplatedetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3313), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3314), new TimeSpan(0, 7, 0, 0, 0)),
                            Name = "ADMIN",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "A6WZZDMSOY6XEPH4VJRSRVTAXICX34US",
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3324), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3325), new TimeSpan(0, 7, 0, 0, 0)),
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.ThemeUserTemplateDetail", b =>
                {
                    ...
                    b.ToTable("ThemeUserTemplateDetail");
                });
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1c66ea9e-fbba-467f-8145-25f3c6e4cee1",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3178), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            FullName = "admin",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3178), new TimeSpan(0, 7, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d5271c3c-9214-4f79-9341-0c56aa1c0048",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3238), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "user@gmail.com",
                            EmailConfirmed = true,
                            FullName = "user",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3238), new TimeSpan(0, 7, 0, 0, 0)),
                            LockoutEnabled = false,
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3372), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3372), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            UserId = new Guid("a3ee2988-67b2-4017-b63b-a0dae4708359"),
                            RoleId = new Guid("89fca251-f021-425b-de62-08dcdfcdb851"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3381), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 19, 18, 5, 13, 786, DateTimeKind.Unspecified).AddTicks(3381), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.UserTemplateDetail", b =>
                {
                    ...
                    b.Property<Guid?>("ParentTemplateDetailId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ParentTemplateDetailId");
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.UserTemplateDetail", b =>
                {
                    b.HasOne("PoemTown.Repository.Entities.UserTemplateDetail", "ParentTemplateDetail")
                        .WithMany()
                        .HasForeignKey("ParentTemplateDetailId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ParentTemplateDetail");
