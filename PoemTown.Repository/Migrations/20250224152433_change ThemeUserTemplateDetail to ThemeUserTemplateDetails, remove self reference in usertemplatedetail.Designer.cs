...
namespace PoemTown.Repository.Migrations
{
    ...
    [Migration("20250224152433_change ThemeUserTemplateDetail to ThemeUserTemplateDetails, remove self reference in usertemplatedetail")]
    partial class changeThemeUserTemplateDetailtoThemeUserTemplateDetailsremoveselfreferenceinusertemplatedetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7244), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7246), new TimeSpan(0, 7, 0, 0, 0)),
                            Name = "ADMIN",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "A6WZZDMSOY6XEPH4VJRSRVTAXICX34US",
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7253), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7254), new TimeSpan(0, 7, 0, 0, 0)),
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6dcb031b-aa8a-41ba-ba46-b4b8fba0deef",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7090), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            FullName = "admin",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7090), new TimeSpan(0, 7, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a2fbc748-9670-4eb2-856a-d0c9f5f09d0d",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7165), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "user@gmail.com",
                            EmailConfirmed = true,
                            FullName = "user",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7165), new TimeSpan(0, 7, 0, 0, 0)),
                            LockoutEnabled = false,
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7296), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7296), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            UserId = new Guid("a3ee2988-67b2-4017-b63b-a0dae4708359"),
                            RoleId = new Guid("89fca251-f021-425b-de62-08dcdfcdb851"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7304), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 24, 22, 24, 32, 629, DateTimeKind.Unspecified).AddTicks(7304), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
