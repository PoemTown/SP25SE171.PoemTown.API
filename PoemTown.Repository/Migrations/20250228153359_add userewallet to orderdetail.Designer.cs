...
namespace PoemTown.Repository.Migrations
{
    ...
    [Migration("20250228153359_add userewallet to orderdetail")]
    partial class adduserewallettoorderdetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(528), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(529), new TimeSpan(0, 7, 0, 0, 0)),
                            Name = "ADMIN",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "A6WZZDMSOY6XEPH4VJRSRVTAXICX34US",
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(536), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(537), new TimeSpan(0, 7, 0, 0, 0)),
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fbc0c3a4-b703-4582-99e6-5020d68ac179",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(377), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            FullName = "admin",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(377), new TimeSpan(0, 7, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "64feac8d-431f-4945-885b-c0173c350b74",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(449), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "user@gmail.com",
                            EmailConfirmed = true,
                            FullName = "user",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(449), new TimeSpan(0, 7, 0, 0, 0)),
                            LockoutEnabled = false,
            ...
            modelBuilder.Entity("PoemTown.Repository.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(577), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(577), new TimeSpan(0, 7, 0, 0, 0))
                        },
                        new
                        {
                            UserId = new Guid("a3ee2988-67b2-4017-b63b-a0dae4708359"),
                            RoleId = new Guid("89fca251-f021-425b-de62-08dcdfcdb851"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(584), new TimeSpan(0, 7, 0, 0, 0)),
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 2, 28, 22, 33, 58, 517, DateTimeKind.Unspecified).AddTicks(584), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
